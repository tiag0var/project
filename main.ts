function spawn_enemies (num: number) {
    for (let index = 0; index < num; index++) {
        ememy = sprites.create(myEnemy._pickRandom(), SpriteKind.Enemy)
        ememy.setPosition(140, 105)
        ememy.follow(football, 30)
    }
...
function real_player () {
    ...
    controller.moveSprite(football, 100, 100)
}
function coins () {
...
function welcome () {
    scene.setBackgroundImage(img`
        ...
        aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
        `)
    game.showLongText("welcome to escape the danger  ", DialogLayout.Bottom)
}
